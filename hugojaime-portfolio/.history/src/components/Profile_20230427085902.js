        ...
        <Row className="aligh-items-center">
          ...
          <Col xs={12} md={6} xl={7}>
            ...
            <p data-aos="fade-down" className="pprofile">
              Hello, my name is <h3>Hugo Jaime</h3>, and I am a software
              developer with a passion for exploring new technologies and
              creating innovative solutions. With 3 years of experience in the
              field, I have honed my skills in various programming languages and
              ...
              particularly interested in Html5, Css3, JavaScript, React,
              Angular, Node.js, Boostrap, Tailwind, and I stay up-to-date with
              the latest developments in these areas. Throughout my career, I
              have worked on a diverse range of projects, from creating mobile
