      ...
      <Container>
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
            ...
            <p>
              I I am an industrial engineer and technology enthusiast based in
              Colombia. I specialize in creating amazing websites and web
              applications that cater to the needs of people around the world 🚀
              <br />
              <br />
