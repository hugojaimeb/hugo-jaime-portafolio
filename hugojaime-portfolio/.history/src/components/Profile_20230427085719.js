        ...
        <Row className="aligh-items-center">
          ...
          <Col xs={12} md={6} xl={7}>
            ...
            <p data-aos="fade-down" className="pprofile">
              Hello, my name is [Your Name], and I am a software developer with
              a passion for exploring new technologies and creating innovative
              solutions. With [X number of] years of experience in the field, I
              ...
              eager to learn about the latest advancements in the field. I am
              particularly interested in [mention some specific technologies
              that you are interested in], and I stay up-to-date with the latest
              ...
              with [mention some programming languages, platforms, or tools that
              you have worked with], and I am always excited to take on new
