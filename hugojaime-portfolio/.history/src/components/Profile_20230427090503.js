        ...
        <Row className="aligh-items-center">
          ...
          <Col xs={12} md={6} xl={7}>
            ...
            <p data-aos="fade-down" className="pprofile">
              ...
              the years. Overall, I am a dedicated and motivated developer who
              is passionate about technology and creating elegant, efficient
              solutions. If you are looking for a talented and committed
              developer for your team, I would love to hear from you!
            </p>
