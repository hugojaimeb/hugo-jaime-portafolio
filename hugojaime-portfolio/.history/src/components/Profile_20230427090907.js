        ...
        <Row className="aligh-items-center">
          ...
          <Col xs={12} md={6} xl={7}>
            ...
            <p data-aos="fade-down" className="pprofile">
              ...
              building complex enterprise systems.<br></br> I have experience
              working with JavaScript, React.js, Node.js FireBase, Git, Boostrap
              and more, and I am always excited to take on new challenges. In my
              free time, I enjoy experimenting with new technologies and working
              on personal coding projects. I am a firm believer in open-source
              software and have contributed to several open-source projects over
              the years.<br></br> Overall, I am a dedicated and motivated
              developer who is passionate about technology and creating elegant,
              efficient solutions. If you are looking for a talented and
              committed developer for your team, I would love to hear from you!
            </p>
