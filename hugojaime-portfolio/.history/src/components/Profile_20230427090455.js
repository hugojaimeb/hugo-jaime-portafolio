        ...
        <Row className="aligh-items-center">
          ...
          <Col xs={12} md={6} xl={7}>
            ...
            <p data-aos="fade-down" className="pprofile">
              ...
              building complex enterprise systems. I have experience working
              with JavaScript, React.js, Node.js FireBase, Git, Boostrap and
              more, and I am always excited to take on new challenges. In my
